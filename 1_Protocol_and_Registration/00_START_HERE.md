...
- [ ] Manuscript L334–338 rewritten (wording in `07_amendments_and_deviations.md` §4)
- [ ] Manuscript registration statement updated with the OSF DOI once minted
- [ ] Risk-of-bias worksheet verified by both reviewers, or the LLM-assisted provenance
      disclosed (see `06_risk_of_bias_plan.md` §5) — **currently unresolved**
- [ ] Table VI and Table VII corrections applied (`../LaTex PDF/DISCREPANCY_REPORT_v6.md`)
