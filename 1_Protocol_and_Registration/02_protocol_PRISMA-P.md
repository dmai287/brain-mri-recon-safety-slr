...
retrieved full text. Screening was carried out by the reviewers under a fixed rubric, with
flagged records adjudicated against full text; the procedure and its limitations are set out in
`04_eligibility_criteria.md` §4. Records marked `background_only` are cited as context and are **not** counted among the
...
| Full text retrieved | 727 |
| Not retrievable | 654 |
| Excluded at full text | 491 |
| Background only | 16 |
| **Studies included** | **220** (1995–2026) |
